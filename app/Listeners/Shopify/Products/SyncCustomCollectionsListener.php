...
class SyncCustomCollectionsListener implements ShouldQueue
{
    /**
     ...
     * Handle the event.
     *
     * @param  SyncCustomCollecionsFire  $event
     * @return void
     */
    public function handle(SyncCustomCollecionsFire $event)
    {
        ...
        if($event->account->id) {
            ...
            if($shop) {
                ...
                $total_records = $shopifyClient->getCustomCollectionCount();
