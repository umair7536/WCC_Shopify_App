...
class ShopifyProductImages extends BaseModal
{

    protected $fillable = [
        'image_id', 'product_id', 'position', 'alt', 'width', 'height', 'src',
        'variant_ids', 'admin_graphql_api_id', 'created_at', 'updated_at', 'account_id'
    ];
    ...
    protected static $_fillable = [
        'image_id', 'product_id', 'position', 'alt', 'width', 'height', 'src',
        'variant_ids', 'admin_graphql_api_id', 'created_at', 'updated_at'
    ];

    protected $table = 'shopify_product_images';

    protected static $_table = 'shopify_product_images';
    ...
    static public function deleteRecord($id)
    {
        ...
        $image = ShopifyProductImages::getData($id);
        ...
        if (ShopifyProductImages::isChildExists($id, Auth::User()->account_id)) {
    ...
    {
        $old_data = (ShopifyProductImages::find($id))->toArray();
