...
class WccCities extends BaseModal
{

    use SoftDeletes;

    protected $fillable = [
        'city_id', 'name', 'account_id', 'created_at', 'updated_at'
    ];
    ...
    protected $table = 'wcc_cities';

    protected static $_table = 'wcc_cities';
    ...
    static public function inactiveRecord($id)
    {
        ...
        $custom_collection = WccCities::getData($id);
    ...
    static public function deleteRecord($id)
    {
        ...
        if (WccCities::isChildExists($id, Auth::User()->account_id)) {
    ...
    {
        $old_data = (WccCities::find($id))->toArray();
