...
class LeopardsSettings extends BaseModal
{
    ...
    static public function inactiveRecord($id)
    {
        ...
        $record = $leopards_setting->update(['active' => 0]);
    ...
    static public function activeRecord($id)
    {
        ...
        $record = $leopards_setting->update(['active' => 1]);
    ...
    static public function deleteRecord($id)
    {
        ...
        if (LeopardsSettings::isChildExists($id, Auth::User()->account_id)) {
            flash('Child records exist, unable to delete resource')->error()->important();
            return redirect()->route('admin.leopards_settings.index');
        }

        $record = $leopards_setting->delete();
    ...
    {
        $old_data = (LeopardsSettings::find($id))->toArray();
    ...
    static public function getLeopardsSettings($excludeIds = false)
    {
        $where = [
