var Login = function() {
    ...
    return {
        init: function() {
            e(), r(), s(), $.backstretch(["../metronic/assets/pages/media/bg/1.jpg", "../metronic/assets/pages/media/bg/2.jpg", "../metronic/assets/pages/media/bg/3.jpg", "../metronic/assets/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
