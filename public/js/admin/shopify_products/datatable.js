        ...
        a.init({
            src: $("#datatable_ajax"), onSuccess: function (a, e) {
                ...
                "columns": [
                    ...
                    { "data": "image_src","bSortable": true },
                    { "data": "title","bSortable": true },
                    { "data": "inventory","bSortable": false },
                    { "data": "product_type","bSortable": true },
                    { "data": "vendor","bSortable": true },
                    { "data": "actions","bSortable": false }
                ],
                ajax: {
                    // url: "../demo/table_ajax.php",
                    url: route('admin.shopify_products.datatable'),
