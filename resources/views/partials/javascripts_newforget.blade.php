...
<script src="{{ url('metronic/assets/global/plugins/jquery-slimscroll/jquery.slimscroll.min.js') }}"
...
<script src="{{ url('metronic/assets/global/plugins/select2/js/select2.full.min.js') }}"
        type="text/javascript"></script>
<script src="{{ url('metronic/assets/global/plugins/backstretch/jquery.backstretch.min.js') }}"
        type="text/javascript"></script>
...
<script src="{{ url('metronic/assets/pages/scripts/login-4-new.min.js') }}" type="text/javascript"></script>
