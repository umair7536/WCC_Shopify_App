...
<link href="{{ url('metronic/assets/global/css/rs-style.css') }}" rel="stylesheet" id="style_components" type="text/css" />
...
<link href="{{ url('metronic/assets/layouts/layout/css/themes/darkblue.min.css') }}" rel="stylesheet" type="text/css" id="style_color" />
<link href="{{ url('metronic/assets/layouts/layout/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
<link href="{{ url('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css') }}" rel="stylesheet" type="text/css" />
