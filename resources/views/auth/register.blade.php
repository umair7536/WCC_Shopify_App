    ...
    <form class="register-form" role="form" method="POST" action="{{ url('/register') }}">
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input id="name" class="form-control placeholder-no-fix" type="text" value="{{ old('name') }}"
        ...
        <div class="form-group">
            ...
            <div class="input-icon">
                ...
                <input id="email" class="form-control placeholder-no-fix" name="email" type="email" placeholder="Email"
        ...
        <div class="form-group">
            ...
            <div class="controls">
                <div class="input-icon">
                    ...
                    <input id="password-confirm" class="form-control placeholder-no-fix" type="password"
                           autocomplete="off" placeholder="Re-type Your Password" name="password_confirmation"
                           required/></div>
            </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-actions">
            <a href="{{ route('auth.login') }}" id="register-btn" class="btn red btn-outline"> Back </a>
