...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.shopify_tags.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('shopify_tags_create'))
                    <a class="btn btn-success" href="{{ route('admin.shopify_tags.create') }}"
                       data-target="#ajax_shopify_tags" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th width="55%">@lang('global.shopify_tags.fields.name')</th>
                        <th>@lang('global.shopify_tags.fields.products')</th>
                        <th width="20%">@lang('global.shopify_tags.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_shopify_tags" role="basic" aria-hidden="true"
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/shopify_tags/datatable.js') }}" type="text/javascript"></script>
