...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.logs.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
            ...
            <div class="table-container">
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        <th width="3%">@lang('global.logs.fields.id')</th>
                        <th>@lang('global.logs.fields.datetime')</th>
                        <th>@lang('global.logs.fields.screen')</th>
                        <th>@lang('global.logs.fields.user')</th>
                        <th style="width: 20%">@lang('global.logs.fields.actions')</th>
                    </tr>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/logs/datatable.js') }}" type="text/javascript"></script>
