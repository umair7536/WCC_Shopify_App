...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.shopify_plans.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('shopify_plans_create'))
                    <a class="btn btn-success" href="{{ route('admin.shopify_plans.create') }}"
                       data-target="#ajax_shopify_plans" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
                @if(Gate::allows('shopify_plans_sort'))
                    <a href="{{ route('admin.shopify_plans.sort') }}"
                       class="btn btn-success">@lang('global.shopify_plans.fields.sort')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.shopify_plans.fields.name')</th>
                        <th>@lang('global.shopify_plans.fields.price')</th>
                        <th>@lang('global.shopify_plans.fields.quota')</th>
                        <th width="20%">@lang('global.shopify_plans.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        ...
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="quota">
                        </td>
                        <td>
    ...
    <div class="modal fade" id="ajax_shopify_plans" role="basic" aria-hidden="true"
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/shopify_plans/datatable.js') }}" type="text/javascript"></script>
