...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.shopify_webhooks.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('shopify_webhooks_create'))
                    <a class="btn btn-success" href="{{ route('admin.shopify_webhooks.create') }}" data-target="#ajax_shopify_webhooks" data-toggle="modal">@lang('global.app_add_new')</a>
                    {!! Form::open(array(
                ...
                @if(Gate::allows('shopify_webhooks_sort'))
                    <a href="{{ route('admin.shopify_webhooks.sort') }}"
                       class="btn btn-success">@lang('global.shopify_webhooks.fields.sort')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.shopify_webhooks.fields.address')</th>
                        <th>@lang('global.shopify_webhooks.fields.topic')</th>
                        <th>@lang('global.shopify_webhooks.fields.format')</th>
                        <th width="20%">@lang('global.shopify_webhooks.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        ...
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="format">
                        </td>
                        <td>
    ...
    <div class="modal fade" id="ajax_shopify_webhooks" role="basic" aria-hidden="true"
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/shopify_webhooks/datatable.js') }}" type="text/javascript"></script>
