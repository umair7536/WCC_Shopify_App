...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.consignees.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('consignees_create'))
                    <a class="btn btn-success" href="{{ route('admin.consignees.create') }}" data-target="#ajax_consignees" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
                @if(Gate::allows('consignees_sort'))
                    <a href="{{ route('admin.consignees.sort') }}"
                       class="btn btn-success">@lang('global.consignees.fields.sort')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.consignees.fields.city_id')</th>
                        <th>@lang('global.consignees.fields.name')</th>
                        <th>@lang('global.consignees.fields.email')</th>
                        <th>@lang('global.consignees.fields.phone')</th>
                        <th width="20%">@lang('global.consignees.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_consignees" role="basic" aria-hidden="true"
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/consignees/datatable.js') }}" type="text/javascript"></script>
