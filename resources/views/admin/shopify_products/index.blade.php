...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.shopify_products.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('shopify_products_create'))
                    <a class="btn btn-success" href="{{ route('admin.shopify_products.sync_products') }}" data-toggle="modal">Sync Products</a>
                    {{--<a class="btn btn-success" href="{{ route('admin.shopify_products.create') }}"--}}
                       {{--data-target="#ajax_shopify_products" data-toggle="modal">@lang('global.app_add_new')</a>--}}
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.shopify_products.fields.image_src')</th>
                        <th>@lang('global.shopify_products.fields.title')</th>
                        <th>@lang('global.shopify_products.fields.inventory')</th>
                        <th>@lang('global.shopify_products.fields.product_type')</th>
                        <th>@lang('global.shopify_products.fields.vendor')</th>
                        <th width="20%">@lang('global.shopify_products.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        ...
                        <td></td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="product_type">
                        </td>
                        <td>
                            <input type="text" class="form-control form-filter input-sm" name="vendor">
                        </td>
                        <td>
    ...
    <div class="modal fade" id="ajax_shopify_products" role="basic" aria-hidden="true"
    ...
    <div class="modal fade" id="ajax_shopify_products_detail" role="basic" aria-hidden="true"  style=" left:10%; width: 80%; top:2%;">
        <div class="modal-content">
            <div class="modal-body">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/shopify_products/datatable.js') }}" type="text/javascript"></script>
