...
@section('title')
    <!-- BEGIN PAGE TITLE-->
    <h1 class="page-title">@lang('global.shopify_customers.title')</h1>
    <!-- END PAGE TITLE-->
@endsection
...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('shopify_customers_create'))
                    <a class="btn btn-success" href="{{ route('admin.shopify_customers.sync_customers') }}" data-toggle="modal">Sync Customers</a>
                    <a class="btn btn-success" href="{{ route('admin.shopify_customers.create') }}" data-target="#ajax_shopify_customers" data-toggle="modal">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th>@lang('global.shopify_customers.fields.first_name')</th>
                        <th>@lang('global.shopify_customers.fields.last_name')</th>
                        <th>@lang('global.shopify_customers.fields.phone')</th>
                        <th>@lang('global.shopify_customers.fields.email')</th>
                        <th>@lang('global.shopify_customers.fields.city')</th>
                        <th>@lang('global.shopify_customers.fields.province')</th>
                        <th width="17%">@lang('global.shopify_customers.fields.actions')</th>
                    </tr>
    ...
    <div class="modal fade" id="ajax_shopify_customers_detail" role="basic" aria-hidden="true"  style=" left:10%; width: 80%; top:2%;">
        <div class="modal-content">
            <div class="modal-body">
                <span> &nbsp;&nbsp;Loading... </span>
            </div>
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/shopify_customers/datatable.js') }}" type="text/javascript"></script>
