...
@section('content')
        ...
        <div class="portlet-title">
            ...
            <div class="actions">
                @if(Gate::allows('roles_create'))
                    <a class="btn btn-success" href="{{ route('admin.roles.create') }}">@lang('global.app_add_new')</a>
                @endif
            </div>
        </div>
            ...
            <div class="table-container">
                ...
                <table class="table table-striped table-bordered table-hover table-checkable" id="datatable_ajax">
                    ...
                    <tr role="row" class="heading">
                        ...
                        <th width="10%">@lang('global.roles.fields.commission')</th>
                        <th width="20%">@lang('global.roles.fields.actions')</th>
                    </tr>
                    <tr role="row" class="filter">
                        ...
                        <td>
                            <div class="input-group">
                                <input type="number" min="0" max="100" class="form-control form-filter input-sm"
                                       name="commission">
    ...
    <div class="modal fade" id="ajax_role" role="basic" aria-hidden="true">
        <div class="modal-content rota-popup">
...
@section('javascript')
    ...
    <script src="{{ url('js/admin/roles/datatable.js') }}" type="text/javascript"></script>
